...
// ListUsers provides a mock function with given fields: ctx, role
func (_m *MockAuthService) ListUsers(ctx context.Context, role string) ([]*domain.User, error) {
...
//   - ctx context.Context
//   - role string
func (_e *MockAuthService_Expecter) ListUsers(ctx interface{}, role interface{}) *MockAuthService_ListUsers_Call {
	return &MockAuthService_ListUsers_Call{Call: _e.mock.On("ListUsers", ctx, role)}
}

func (_c *MockAuthService_ListUsers_Call) Run(run func(ctx context.Context, role string)) *MockAuthService_ListUsers_Call {
...
func (_c *MockAuthService_ListUsers_Call) Return(_a0 []*domain.User, _a1 error) *MockAuthService_ListUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAuthService_ListUsers_Call) RunAndReturn(run func(context.Context, string) ([]*domain.User, error)) *MockAuthService_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
